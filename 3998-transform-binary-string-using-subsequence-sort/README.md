<h2><a href="https://leetcode.com/contest/weekly-contest-511/problems/transform-binary-string-using-subsequence-sort">3993. Transform Binary String Using Subsequence Sort</a></h2><h3>Medium</h3><hr><p>You are given a binary string <code>s</code>.</p>
